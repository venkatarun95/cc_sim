...
fn main() {
	...
	cc::Build::new().file("src/bbr/simul.c").compile("simul");
	...
	let bindings = bindgen::Builder::default()
		...
		.whitelist_function("create_bbr")
		.whitelist_function("on_ack")
		.whitelist_function("on_send")
		.whitelist_function("on_timeout")
		.whitelist_function("get_cwnd")
		.whitelist_function("get_intersend_time")
		.whitelist_function("bbr_print_wrapper")
